...
def load_dataset(dataset):
    ...
    if 'OTB2015' in dataset:
        ...
        base_path = join('/private/dataset/', dataset)
        json_path = join('/private/UDT_pytorch/track/dataset/', dataset + '.json')
        ...
        for f_video in father_videos:
            ...
            info[f_video] = {'image_files_color': image_files_color, 'gt': gt, 'name': f_video}
