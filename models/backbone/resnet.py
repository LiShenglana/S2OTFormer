...
class ResNet(Backbone):
    ...
    def __init__(self, block, layers, output_layers, num_classes=1000, inplanes=64, dilation_factor=1, frozen_layers=()):
        ...
        self.conv1 = nn.Conv2d(3, inplanes, kernel_size=7, stride=2, padding=3,  #3
                               bias=False)
        ...
        # self.used_layers = [1, 2, 3]
        # self.layer3_use = True if 3 in self.used_layers else False
        # self.layer4_use = True if 4 in self.used_layers else False
        #
        # if self.layer3_use:
