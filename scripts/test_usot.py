...
def parse_args():
    ...
    parser.add_argument('--resume', default='/home/cscv/Documents/lsl/USOT-copy/scripts/test2/USOTFormer/VOT_train/test/attention_cat_addori_ln_linear_nodownsample_corratt/checkpoint_e30.pth', type=str, help='pretrained model')
